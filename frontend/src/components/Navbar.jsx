    ...
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className={`absolute top-0 bottom-0 left-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
        ...
        <div className='flex flex-col text-gray-700'>
          ...
          <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 bor' to='/collection'>COLLECTION</NavLink>
          <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 bor' to='/about'>ABOUT</NavLink>
          <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 bor' to='/contact'>CONTACT</NavLink>
